...
@section('content')
    ...
    @endif
                        ...
                        <form method="POST" action="{{ route('admitCard.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="name"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Student\'s Name') }}
                                    {!! $mandate !!}</label>
                                ...
                                <div class="col-md-6 mt-md-2">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('gender') is-invalid @enderror" type="radio"
                                            @if (old('gender') == 'Male') checked @endif name="gender" name="gender"
                                            id="male" value="Male" required autofocus>
                                        <label class="form-check-label" for="male">Male</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('gender') is-invalid @enderror" type="radio"
                                            @if (old('gender') == 'Female') checked @endif name="gender" id="female"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('class') is-invalid @enderror" name="class"
                                        ...
                                        <option @if (old('class') == 'Play') selected @endif value="Play">Play
                                        </option>
                                        <option @if (old('class') == 'Nursery') selected @endif value="Nursery">Nursery
                                        </option>
                                        <option @if (old('class') == 'LKG') selected @endif value="LKG">LKG
                                        </option>
                                        <option @if (old('class') == 'UKG') selected @endif value="UKG">UKG
                                        </option>
                                        <option @if (old('class') == 'Std.1') selected @endif value="Std.1">Std.1
                                        </option>
                                        <option @if (old('class') == 'Std.2') selected @endif value="Std.2">Std.2
                                        </option>
                                        <option @if (old('class') == 'Std.3') selected @endif value="Std.3">Std.3
                                        </option>
                                        <option @if (old('class') == 'Std.4') selected @endif value="Std.4">Std.4
                                        </option>
