...
<html lang="en">
    ...
    <body>
        <table style="margin-bottom:-6px" class="main-table mx-auto">
                        ...
                        <tr>
                            ...
                            <td style="width: 100%">
                                <table style="width: 100%">
                                    <tr>
                                        <td>
                                            <h1 class="mb-0 text-center">Anshu Memorial Academy</h1>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="font-size:0.8rem" class="mb-0 mb-0 text-center">Run & Managed by
            ...
            <tr>
                <!-- student details -->
                <td class="mb-0 px-2" style="height:260px;border: 1px solid black;">
                    <table class="mx-auto mt-2" style="width: 100%;">
                        <tr>
                            <td>
                                <h6 class="mb-1 text-center"> REPORT CARD [ANNUAL EXAMINATION] </h6>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <table class="table-sm table-borderless table-borderless table">
                        <tr>
                            <th>Name</th>
                            <td>:</td>
                            <td>{{ $stu->name }}</td>
                            ...
                            <td style="p-0" rowspan="5" width="150">
                                <img class="border-dark border" width="100%"
            ...
            <tr>
                ...
                <td class="py-0 align-baseline" style="height:355px;border: 1px solid black;">
                    <table class="table-sm table-borderless w-100 table">
                        <tr>
                            <td>
                                <table class="table-sm marks mb-0 table text-center">
                                    <thead>
                                        <tr>
                                    ...
                                    @if (!in_array($stu->class, $classes))
                                        <tr>
                                            ...
                                            <td>{{ res($result->marks->science + $result->marks->science_oral)['g'] }}
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tr>
                                        <td colspan="5" class="ps-5 text-start">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td width="100%" class="d-flex justify-content-center">
                                            <table class="p-2 text-center" width="160">
                                                <tr class="bg-success fw-bold bg-success text-center text-white">
            ...
            <tr>
                <td class="p-2">
                    <table class="table-sm table-bordered border-dark table border text-center">
                        <tr>
            ...
            <tr>
                ...
                <td class="align-bottom" style="height:185px;position:relative;">
                    <table class="table-sm table-borderless table text-center">
                        <tr>
                            <td></td>
                            <td width="25%" class="align-bottom">{{ date('d-m-Y') }}</td>
                            <td width="25%"></td>
                            <td width="25%"><img class="exam-ctrl"
                                    src="https://anshumemorial.in/v2/public/images/web/chandani_roy512.webp"></td>
                            <td width="25%">
                                <img class="p-sign"
                                    src="https://anshumemorial.in/v2/public/images/web/principal_sign300.webp">
                                <img class="p-seal"
                                    src="https://anshumemorial.in/v2/public/images/web/principal_seal400.webp">
                            </td>
                        </tr>
                        <tr>
                            <td>Print Date</td>
        ...
        <small style="font-size:10px;" class="w-100 d-inline-block bg-light text-center align-baseline">Designed &amp;
