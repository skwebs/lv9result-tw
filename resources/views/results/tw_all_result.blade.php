...
<html lang="en">
    ...
    <body class="A4">
        @foreach ($results->chunk(2) as $chunk)
            @foreach ($chunk as $result)
                ...
                <section class="sheet flex flex-col p-4">
                                    ...
                                    <table class="table w-full text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border-b-[1px] border-gray-300">
                                                ...
                                                <td class="whitespace-nowrap px-3 py-2">{{ $result->marks->hindi }}
                                                </td>
                                                <td class="whitespace-nowrap px-3 py-2">--</td>
                                                <td class="whitespace-nowrap px-3 py-2">{{ $result->marks->hindi }}
                                                </td>
                                            ...
                                            <tr class="border-b-[1px] border-gray-300">
                                                ...
                                                <td class="whitespace-nowrap px-3 py-2">100</td>
                                                <td class="whitespace-nowrap px-3 py-2">{{ $result->marks->english }}
                                                </td>
                                                <td class="whitespace-nowrap px-3 py-2">--</td>
                                                <td class="whitespace-nowrap px-3 py-2">{{ $result->marks->english }}
                                                </td>
                                            ...
                                            <tr class="border-b-[1px] border-gray-300">
                                                ...
                                                <td class="whitespace-nowrap px-3 py-2">100</td>
                                                <td class="whitespace-nowrap px-3 py-2">{{ $result->marks->maths }}
                                                </td>
                                                <td class="whitespace-nowrap px-3 py-2">--</td>
                                                <td class="whitespace-nowrap px-3 py-2">{{ $result->marks->maths }}
                                                </td>
                                            ...
                                            <tr class="border-b-[1px] border-gray-300">
                                                <th class="whitespace-nowrap px-3 py-2 text-left">General Knowledge
                                                </th>
                                                <td class="whitespace-nowrap px-3 py-2">
                                                    @if (!in_array($result->admitCard->class, $classes))
                                                        100
                    ...
                    <div class="w-full bg-gray-100 py-1 text-center text-xs">
                        ...
                        <a class="font-semibold text-blue-600" href="https://skwebs.github.io">Anshu Memorial Academy
                            (IT
                            Team)
                        </a>
                    </div>
