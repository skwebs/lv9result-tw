    ...
    <body class="A4">
        ...
        <section class="sheet flex flex-col p-4">
            ...
            <div class="main-content flex h-full flex-col border-2 border-black">
                                ...
                                <div class="flex-grow">
                                    <table class="w-full text-left">
                                        <tr>
                                            ...
                                            <td class="whitespace-nowrap px-3 py-2">:</td>
                                            <td class="whitespace-nowrap px-3 py-2">{{ $result->admitCard->class }}</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="whitespace-nowrap px-3 py-2">:</td>
                                            <td class="whitespace-nowrap px-3 py-2">{{ $result->admitCard->roll }}</td>
                                        </tr>
                                        <tr>
                            ...
                            <table class="table w-full text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b-[1px] border-gray-300">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-2">--</td>
                                        <td class="whitespace-nowrap px-3 py-2">{{ $result->marks->hindi }}</td>
                                        <td class="whitespace-nowrap px-3 py-2">{{ res($result->marks->hindi)['g'] }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="border-b-[1px] border-gray-300">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-2">--</td>
                                        <td class="whitespace-nowrap px-3 py-2">{{ $result->marks->english }}</td>
                                        <td class="whitespace-nowrap px-3 py-2">{{ res($result->marks->english)['g'] }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="border-b-[1px] border-gray-300">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-2">--</td>
                                        <td class="whitespace-nowrap px-3 py-2">{{ $result->marks->maths }}</td>
                                        <td class="whitespace-nowrap px-3 py-2">{{ res($result->marks->maths)['g'] }}
                                        </td>
                                    </tr>
                ...
                <!-- footer -->
                <div>
                    <div class="flex justify-between border-t-2 border-black bg-green-700 px-1 py-[1px] text-white">
                        <!-- call -->
                        <div class="flex">
